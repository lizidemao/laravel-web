	...
	<center>
		...
		<div class="row form-group">
			<div class="col-md-12">
				...
				<input type="text" id="email" name="username" class="form-control" placeholder="账号" required>
			</div>
		</div>
		 ...
		 <div class="row form-group">
			<div class="col-md-12">
				...
				<input type="password" id="subject" name="password" class="form-control" placeholder="密码" required>
			</div>
		</div> 
		<br/>
		<br/>
		<center>
		<div class="row form-group" >
			<input type="submit" value="登录" class="btn btn-primary col-md-4" style="margin-left:390px">
		</div>
		</center>
	</form>
